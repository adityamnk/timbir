...
Purdue = u'Purdue University' 
project = u'TIMBIR'
copyright = u'2013-2016, ' + Purdue
author = u'K. Aditya Mohan, Singanallur Venkatakrishnan, Charles A. Bouman'
...
texinfo_documents = [
  ...
  Purdue, 
  project, 
  'The time-interlaced model-based iterative reconstruction (TIMBIR).',
  'Miscellaneous'),
]
