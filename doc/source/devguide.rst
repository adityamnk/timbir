...
on `GitHub <https://github.com>`_ and fork the TIMBIR repository by 
clicking the **Fork** button in the header of the 
`TIMBIR repository <https://github.com/adityamnk/timbir>`__: 
...
then you should consider contributing back to the TIMBIR project. For this, 
...
between your forked branch and the original TIMBIR repository. 
