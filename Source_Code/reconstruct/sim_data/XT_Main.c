...
int main(int argc, char **argv)
{
	...
	float *projections, *weights, *proj_angles, *proj_times, *recon_times, vox_wid, rot_center, sig_s, sig_t, c_s, c_t, convg_thresh;
	FILE *debug_msg_ptr;
	...
	reconstruct (projections, weights, proj_angles, proj_times, recon_times, proj_rows, proj_cols, proj_num, recon_num, vox_wid, rot_center, sig_s, sig_t, c_s, c_t, convg_thresh, remove_rings, remove_streaks, restart, debug_msg_ptr);
	free(projections);
	free(weights);
	free(proj_angles);
	free(proj_times);
